...
class JwtTokenUtil : Serializable {
    ...
    fun getUsernameFromToken(token: String): String {
        return getClaimFromToken(token, Function<Claims, String> { it.getSubject() })
    }
    ...
    fun getExpirationDateFromToken(token: String): Date {
        return getClaimFromToken(token, java.util.function.Function<Claims, Date> { it.getExpiration() })
    }
